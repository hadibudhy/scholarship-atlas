...
export function SiteFooter() {
  return <footer className="site-footer"><div className="site-shell footer-inner"><span>© 2026 Scholarship Atlas</span><span>Funding details change. Confirm every claim with the linked official source.</span><nav aria-label="Legal"><Link href="/about">About</Link><Link href="/terms">Terms of Service</Link><Link href="/privacy">Privacy Policy</Link></nav></div></footer>;
}
